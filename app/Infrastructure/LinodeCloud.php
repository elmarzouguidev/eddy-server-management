...
class LinodeCloud implements ServerProvider, HasCredentials
{
    /**
     * The Hetzner Cloud API base URL.
     */
    private const API_URL = 'https://api.linode.com/v4/';
    ...
    private function mapDatacenter(array $datacenter): Region
    {
        ...
        return new Region($datacenter['id'], $datacenter['label']);
    }

    /**
     * Get all available server regions.
     *
     * @see https://www.linode.com/docs/api/regions/
     */
    public function findAvailableServerRegions(): Collection
    {
        $data = $this->getAll('regions')
    ...
    {
        $datacenter = $this->http->get(self::API_URL . "regions/{$regionId}");
